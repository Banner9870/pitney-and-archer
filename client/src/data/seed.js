...
export const SEED_GUIDES = [
  ...
  // ----- guide-006: Bronzeville Rising (journalist — isNewsroom) -----
  {
    ...
    remixCount: 1,
    isNewsroom: true,
    newsroomSource: 'suntimes',
    createdAt: '2026-02-05T12:00:00Z',
    isSessionCreated: false,
  },

  // ----- guide-007: WBEZ's Guide to Live Music in Logan Square -----
  {
    id: 'guide-007',
    title: "WBEZ's Guide to Live Music in Logan Square",
    description: "Where to hear live music in Logan Square — from the corner bar with the Tuesday jazz set to the ballroom that's been a Chicago institution for over a century.",
    authorId: 'user-alkeefe',
    collaborators: [],
    neighborhood: 'Logan Square',
    additionalNeighborhoods: [],
    badges: ['Live Music', 'Bars'],
    modules: [
      {
        type: 'place',
        placeId: 'place-logan-square-auditorium',
        name: 'Logan Square Auditorium',
      ...
      },
      {
        type: 'playlist',
        platform: 'spotify',
        title: 'Chicago Live Music: Logan Square Picks',
        description: "Artists WBEZ has featured from the Logan Square scene — jazz, indie, cumbia, and everything in between.",
        embedUrl: 'https://open.spotify.com/embed/playlist/37i9dQZF1DWSXBu5naYCM9',
        editorNote: "This is what the neighborhood sounds like.",
      },
      {
        type: 'event',
        name: 'Logan Square Arts Fest',
        venue: 'Logan Square Boulevard',
        address: 'Logan Blvd between Milwaukee Ave and Kedzie Ave, Chicago, IL 60647',
        date: 'July 2026 — check website',
